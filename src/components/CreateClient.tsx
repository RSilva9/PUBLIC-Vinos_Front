...
export default function CreateClient({ closeModal }: CreateProps){
    const handleCreateClient = async(e: React.FormEvent<HTMLFormElement>)=>{
        ...
        try {
            await wretch(`${apiUrl}/clientes/crear-cliente`)
    ...
    return(
        <div className="relative w-full max-w-lg rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 shadow-2xl">
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Agregar nuevo cliente</h3>
            <form className="flex flex-col gap-4" onSubmit={handleCreateClient}>
                <input type="text" name='clientName' placeholder="Nombre"
                ...
                <input type="text" name='clientDocType' placeholder="Tipo de Documento"
                    className="w-full rounded-full border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 px-4 py-2 text-sm placeholder:text-black dark:placeholder:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/40 focus:border-indigo-500 dark:text-gray-100" required />
                <input type="text" name='clientDocument' placeholder="Documento"
                    className="w-full rounded-full border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 px-4 py-2 text-sm placeholder:text-black dark:placeholder:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/40 focus:border-indigo-500 dark:text-gray-100" required />
                <input type="text" name='clientAddress' placeholder="Domicilio"
                    className="w-full rounded-full border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 px-4 py-2 text-sm placeholder:text-black dark:placeholder:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/40 focus:border-indigo-500 dark:text-gray-100" required />
                <input type="email" name='clientEmail' placeholder="Email"
                    className="w-full rounded-full border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 px-4 py-2 text-sm placeholder:text-black dark:placeholder:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/40 focus:border-indigo-500 dark:text-gray-100" required />
                <input type="tel" name='clientPhone' placeholder="Teléfono"
                    className="w-full rounded-full border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 px-4 py-2 text-sm placeholder:text-black dark:placeholder:text-white shadow-sm focus:outline-none focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/40 focus:border-indigo-500 dark:text-gray-100" required />
